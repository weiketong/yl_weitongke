...
function getQunList(pageNum) {
    ...
    $.ajax({
      ...
      error: function(err){
        // 发生错误
        errorPage('data-list','getQunList.java');
      },
    });
}
...
console.log('%c 作者：Ricky Li','color:#3B5EE1;font-size:30px;font-family:"微软雅黑"');
